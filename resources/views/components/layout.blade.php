          ...
          <div class="app-brand demo py-5">
            <a href="" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{ asset('assets/img/logo/' . App\Models\SchoolData::first()->logo) }}" alt="" width="55" height="55" class="me-2" />
              </span>
              <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">{{ App\Models\SchoolData::first()->namaSingkat }}</span>
            </a>
          ...
          <ul class="menu-inner py-1 mt-3">
            ...
            <li class="menu-item {{ Request::is('absensi*') ? 'active' : ''}}">
              <a href="/absensi" class="menu-link ">
                ...
                <div data-i18n="Basic">Tambah Absensi</div>
              </a>
            </li>
            ...
            <li class="menu-item {{ Request::is('pesan') ? 'active' : ''}}">
              <a href="/pesan" class="menu-link ">
                ...
                <div data-i18n="Basic">Log Notifikasi</div>
              </a>
            </li>
            <li class="menu-item {{ Request::is('profile') ? 'active' : ''}}">
              <a href="/profile" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-home"></i>
                <div data-i18n="Basic">Profile Sekolah</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../assets/img/avatars/usr.jpg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{ ucfirst(auth()->user()->role ?? 'Guru' )}}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" onclick="window.logout()">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column text-center">
                <div class="mb-2 mb-md-0 w-100">
                  ...
                  | {{App\Models\SchoolData::first()->namaSekolah}}
                </div>
              </div>
            </footer>
            <!-- / Footer -->
