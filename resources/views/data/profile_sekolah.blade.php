                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('assets/img/logo/' . $school->logo) }}" alt="user-avatar"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="namaSekolah"
                                    value="{{ $school->namaSekolah ?? ''}}" autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="firstName" class="form-label">Nama singkat</label>
                                <input class="form-control" type="text" name="namaSingkat"
                                    value="{{$school->namaSingkat ?? ''}}" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="kepalaSekolah"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="email" name="status"
                                    value="{{$school->status ?? ''}}" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" name="alamat"
                                    aria-label="With textarea">{{$school->alamat ?? ''}}</textarea>
                            </div>
                        </div>
                        <div class="mt-2">
